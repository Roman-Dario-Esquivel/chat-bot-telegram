...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    ...
    public void onUpdateEventReceived(Update update) {
        // TODO: escribiremos la funcionalidad principal del bot aquí
         ...
         String[] motivarChiste = {"¿Qué hace una abeja en el gimnasio? ¡Zum-ba!",
...
"¿Qué le dice una uva verde a una roja? ¡¡Respira, respira!!"};
            String[] motivarFrase = {"'El éxito no es la clave de la felicidad. La felicidad es la clave del éxito. Si amas lo que haces, tendrás éxito.' - Albert Schweitzer",
...
"'No esperes a que pase la tormenta, aprende a bailar bajo la lluvia.' - Anónimo"};
        ...
        if (getMessageText().toLowerCase().contains("me llamo")||getMessageText().toLowerCase().contains("mi nombre es")||getMessageText().toLowerCase().contains("soy")){
            String nombre= "";
